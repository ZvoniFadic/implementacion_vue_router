            ...
            <div
                ...
                <ul class="nav navbar-nav ml-auto" id="menu-v8">
                    <li class="nav-item" role="presentation">
                      ...
                      <router-link class="" :to="{name: 'portada'}">Portada</router-link> 
                    </li>
                    <li class="nav-item" role="presentation">
                      <!-- REEMPLAZAR CON ELEMENTO ROUTER LINK A CON RUTA NOMBRADA -->
                      <router-link class="" :to="{name: 'sobremi'}">Sobre Mi</router-link> 
                    </li>
                    <li class="nav-item" role="presentation">
                      <!-- REEMPLAZAR CON ELEMENTO ROUTER LINK A CON RUTA ESTÁTICA -->
                      <router-link class="" to="/contacto">Contacto</router-link> 
                    </li>
                    <li class="nav-item" role="presentation">
                      <!-- REEMPLAZAR CON ELEMENTO ROUTER LINK A RUTA ESTÁTICA -->
                      <router-link class="" to="/post/1">Último Post</router-link> 
                    </li>
                </ul>
            </div>
        </div>
